...
export const correctString = (value: string): string => {
  return (
    value
      ...
      // .replaceAll("Stay tuned for updates on empire", "")
      ...
      // .replaceAll("Read new chapters at empire", "")
      // .replaceAll("Stay updated through empire", "")
      // .replaceAll("Experience more on empire", "")
